...
export default {
  ...
  props: {
    ...
    message: {
      type: String,
      default: 'This website uses cookies. To learn more, visit our'
    },
    // button
    linkLabel: {
      type: String,
  ...
  <transition :name="transition">
    <div v-if="show" class="cookie-consent" role="dialog">
      ...
      <section @click="dismiss">
        <slot name="button">
          <button class="cookie-consent-compliance" type="button">{{ buttonLabel }}</button>
        </slot>
      </section>
    </div>
  </transition>
...
<style lang="scss">
@import "~/assets/sass/components/app-cookie-consent";
@import "~/assets/sass/components/app-cookie-consent-bottom";
@import "~/assets/sass/components/app-cookie-consent-transition";
</style>