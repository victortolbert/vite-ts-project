...
import { PropertyInspectionFormMain } from '@/types'

// Controls
import AssetViewerComponent from './AssetViewerComponent.vue'
import BooleanCameraWrapperComponent from './Controls/BooleanCameraWrapperComponent.vue'
import BooleanWrapperComponent from './Controls/BooleanWrapperComponent.vue'
import CheckboxWrapperComponent from './Controls/CheckboxWrapperComponent.vue'
import NumericWrapperComponent from './Controls/NumericWrapperComponent.vue'
import TextboxCameraWrapperComponent from './Controls/TextboxCameraWrapperComponent.vue'

// Sections
import InteriorSectionComponent from './InteriorSectionComponent.vue'
import ElevationSectionComponent from './ElevationSectionComponent.vue'
import RoofSectionComponent from './RoofSectionComponent.vue'
...
export default class MainSectionComponent extends SectionBase<PropertyInspectionFormMain>{
  ...
  mounted() {
    ...
    EventBus.$on(PifEvents.Destroy, () => {
      ...
      EventBus.$off('create-outbuildings')
      EventBus.$off('load-outbuildings')
      EventBus.$off('remove-outbuildings')
    })
