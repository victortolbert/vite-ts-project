...
<template>
  <form
    class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:shadow-md rounded sm:px-8 sm:pt-6 pb-8 mt-4 text-main"
  >
    <div class="mt-4 col-start-1 md:col-end-3">
      <o-field
        label="Title"
        label-for="name"
    ...
    <div class="mt-4 col-start-1">
      <o-field
        ...
        :message="errors.time"
      >
        <o-input id="time" type="number" placeholder="Time" v-model.number="recipe.time" min="1" />
      </o-field>
    </div>
    ...
    <div class="mt-4 col-start-1 flex justify-between">
      <o-field
        label="Image"
        label-for="image"
    ...
    <div class="mt-4">
      <o-field label="Difficulty" class>
        <div class="flex">
          <o-dropdown placeholder="Difficulty" v-model="recipe.difficulty" aria-role="list">
            <template #trigger>
              <o-button variant="primary" type="button" class="w-32">
    ...
    <div class="mt-4 flex justify-center col-start-1 md:col-end-3">
