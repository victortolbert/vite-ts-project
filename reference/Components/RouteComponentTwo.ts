...
export default class RouteComponent extends AutoSchedulerBase<Route> {
    ...
    mounted() {
        EventBus.$on(AutoSchedulerEvents.MoveInspection, (inspectionDetail: ProjectInspectionDetails, showOutline: boolean) => {
            ...
            if (inspectionDetail.ServiceAreaId != this.serviceAreaId) {
                return;
            }
            ...
            forEach(this.divMappers, function (value, key) {
                if (value.inspectionDetailsComponent == null ||  typeof(value.inspectionDetailsComponent.$data) == 'undefined' || value.inspectionDetailsComponent.$data == null) {
                    return;
                }
            ...
            if (divToMove.inspectionDetailsComponent != null) {
