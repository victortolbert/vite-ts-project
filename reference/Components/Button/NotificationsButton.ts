...
@Component({
    ...
    template: `<button
        type="button"
        class="rounded-full bg-primary-600 flex-shrink-0 p-1 text-primary-200 hover:text-white focus:outline-none focus:ring-white focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary-600"
    >
