import { ToastMessageType } from "@ExemplarEnums/Toast";
export class ToastrHelper {

  private static DisplayToast(toastMessageType: ToastMessageType, message: string, title: string, showClose: boolean = false) {
